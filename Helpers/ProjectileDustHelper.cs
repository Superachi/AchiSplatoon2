...
namespace AchiSplatoon2.Helpers
{
    internal static class ProjectileDustHelper
    {
        public static void ShooterTileCollideVisual(BaseProjectile baseProjectile, bool playSound = true)
        {
            ...
            SoundHelper.PlayAudio(Main.rand.NextFromCollection(sounds), volume: 0.15f, pitchVariance: 0.5f, maxInstances: 50, pitch: 1f);
            SoundHelper.PlayAudio(SoundID.Splash, volume: 0.25f, pitchVariance: 0.5f, maxInstances: 50, pitch: 1f);
        }
